...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($nom) || empty($prenom) || empty($telephone) || empty($email)|| empty($password)) {
        ...
        try {
            ...
            $stmt = $pdo->prepare("INSERT INTO client (nom, prenom, telephone, email,password,date_creation) VALUES (:nom, :prenom, :telephone, :email, :password, NOW())");
    ...
    <div class="container mx-auto my-5">
        ...
        <form method="post" class="max-w-md mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="index1.php" class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800">Retour au page d'acceuil</a>
            </div>
        </form>
    </div>
</body>
