...
<body class="bg-gray-50">
    <div class="container mx-auto py-8">
        ...
        <a class="btn btn-info mr-2 py-1 px-2 rounded-md bg-blue-500 text-white hover:bg-blue-600 mb-4 inline-block" href="/CRM/creatlivr.php" role="button">Ajouter un livreur</a>        <div class="overflow-x-auto">
